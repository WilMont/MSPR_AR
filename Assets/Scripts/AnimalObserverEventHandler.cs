...
///
/// Custom handler based on DefaultObserverEventHandler.
/// </summary>
public class AnimalObserverEventHandler : MonoBehaviour
{
    ...
    public GameObject FinderSerpent;
    public GameObject FinderSinge;
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        //Hide the images when a triggering image is recognized.
        FinderSerpent.SetActive(false);
        FinderSinge.SetActive(false);
    }
    ...
    protected virtual void OnTrackingLost()
    {
        ...
        //Display the image when a triggering image is not in sight.
        FinderSerpent.SetActive(true);
        FinderSinge.SetActive(true);
    }
}